					  ...
					  <!-- User Account: style can be found in dropdown.less -->
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<span class="hidden-xs"><?php echo e(session("merchantname")->shopname); ?></span>
							</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header">
									<img src="<?php echo e(asset('myadmin/dist/img/user2-160x160.jpg')); ?>" class="img-circle" alt="User Image" />
									<p>
										<?php echo e(session("merchantname")->shopname); ?>-网站开发
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					...
					<div class="pull-left info">
						<p></p>
						<p><?php echo e(session("merchantname")->shopname); ?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('merchant/merchant')); ?>"><i class="fa fa-circle-o"></i>商家信息</a></li>
            ...
            <li class="active treeview">
             ...
             <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo e(url('merchant/letter')); ?>"><i class="fa fa-circle-o"></i> 浏览用户评价</a></li>
