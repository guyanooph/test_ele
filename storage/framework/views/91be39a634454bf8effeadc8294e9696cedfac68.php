...
<a class="inherit ng-binding" ng-href="/shop/1356235" ng-bind="restaurant.name" href="/shop/<?php echo e($order[0]['shopid']); ?>">三多烤肉拌饭（东亚上北店）</a></h4>
<div class="orderprogress-rstextra">
<span ng-bind="'订单号：' + order.unique_id" class="ng-binding">订单号：<?php echo e($order[0]['orderid']); ?></span> 
...
<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<span class="cell name ng-binding" ng-bind="row.food.name"><?php echo e($food['food']['title']); ?></span> 
<span class="cell quantity ng-binding" ng-bind="row.food.quantity"><?php echo e($food['num']); ?></span> 
<span class="cell price ng-binding" ng-bind="row.food.price * row.food.quantity | number:2"><?php echo e($food['price']*$food['num']); ?></span></div>
<!-- ngSwitchWhen: extra -->
</div>
