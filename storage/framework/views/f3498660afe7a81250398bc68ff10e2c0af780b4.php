					...
					<form class="form-horizontal" action="<?php echo e(URL('merchant/order/update')); ?>/<?php echo e($order->id); ?>" method="post">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="orderid" class="form-control" placeholder="订单号" value="<?php echo e($order->orderid); ?>">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<label class="radio-inline">
									<input type="radio" name="status" id="inlineRadio2" <?php echo e($order->status); ?> value="1"> 未配送
								</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="packet_id" class="form-control" placeholder="使用红包id" value="<?php echo e($order->packet_id); ?>">
								</div>
							</div>
							<div class="form-group">
