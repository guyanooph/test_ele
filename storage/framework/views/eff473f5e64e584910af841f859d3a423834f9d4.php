            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-sm btn-primary" onclick="window.location='<?php echo e(URL('admin/role/create')); ?>'">添加</button>
                  <div class="box-tools">
                ...
                <div class="box-body">
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <button onclick="window.location='<?php echo e(URL('admin/role/edit')); ?>/<?php echo e($v->id); ?>'" class="btn btn-xs btn-primary">编辑</button>
                      <!-- <button class="btn btn-xs btn-success" onclick="window.location='<?php echo e(URL('admin/role/loadNode')); ?>/<?php echo e($v->id); ?>'">分配节点</button>-->
                       <button class="btn btn-xs btn-success" onclick="loadNode('<?php echo e($v->id); ?>','<?php echo e($v->role); ?>')">分配节点</button>
                      </td>
