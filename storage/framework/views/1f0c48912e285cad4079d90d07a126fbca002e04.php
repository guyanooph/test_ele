<?php $__env->startSection('content'); ?>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <button onclick="window.location='<?php echo e(URL('admin/shop/checkCom')); ?>/<?php echo e($list->id); ?>/<?php echo e(3); ?>'" class="btn btn-ms btn-danger">已通过审核作品，更改为审核不通过</button></li>
