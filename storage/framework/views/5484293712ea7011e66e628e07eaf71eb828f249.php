...
<body cute-title="" ng-class="{hidesidebar: layoutState &amp;&amp; layoutState.hideSidebar, smallbody: layoutState.smallBody, whitebody: layoutState.whiteBody}" style="position: relative;" class="hidesidebar">
    ...
    <div ng-switch="state.type" state="layoutState" class="ng-isolate-scope">
        ...
        <header class="carttopbar" ng-switch-when="checkout" topbar-checkout="" state="state">
            <div class="carttopbar-nav container clearfix">
                <span class="carttopbar-nav-path">当前位置：<a ng-href="/place/wx4spk2nqhf" ng-bind="$root.place.name || $root.place.address" class="ng-binding" href="/place/wx4spk2nqhf"><?php echo e($location['address']); ?></a> <i class="icon-arrow-right"></i> <a class="inherit ng-binding" ng-href="/shop/1244889" ng-bind="state.rstName" ng-show="state.rstName" href="/shoplist/<?php echo e($ob->shopid); ?>"><?php echo e($ob->shopname); ?></a> <i class="icon-arrow-right" ng-show="state.rstName"></i> 订单信息</span>
                <div topbar-profilebox="">
                    <div class="topbar-profilebox"><!-- ngIf: $root.user.avatar && $root.topbarType !== 'checkout' -->
                        ...
                        <span class="topbar-profilebox-wrapper" ng-show="$root.user.username"><!-- ngIf: $root.topbarType === 'checkout' --> 
                            <span class="topbar-profilebox-username ng-binding"><?php echo e($user->username); ?></span> 
    ...
    <div id="order_info" class="container clearfix ng-scope"><!-- ngIf: loading --><!-- ngIf: !loading && nofood --><!-- ngIf: !loading && !nofood -->
        <div ng-if="!loading &amp;&amp; !nofood" class="checkout-cart ng-scope ng-isolate-scope" checkout-cart="cart">
            <div class="checkoutcart-container">
                <div class="checkoutcart-title"><h2>订单详情</h2><a ng-href="/shop/<?php echo e($ob->shopid); ?>" href="/shoplist/<?php echo e($ob->shopid); ?>">&lt; 返回商家修改</a></div>
                    ...
                    <dl ng-if="basket.length" ng-repeat="basket in cart.vm.group" class="checkoutcart-group ng-scope">
                        ...
                        <dd ng-repeat="item in basket" class="ng-scope">
                            <div class="checkoutcart-tablerow">
                                <div class="cell itemname ng-binding" ng-bind="item.name" title="<?php echo e($food['food']->title); ?>"><?php echo e($food['food']->title); ?></div>
                                <div class="cell itemquantity">
                                    <button  foodid="<?php echo e($id); ?>" onclick="addShopcart(this,-1)"   ng-click="cart.sub(item)">-</button><input ng-model="item.quantity" ng-change="cart.update(item)" ng-blur="cart.blur(item)" class="ng-pristine ng-valid" value="<?php echo e($food['num']); ?>"><button  foodid="<?php echo e($id); ?>" onclick="addShopcart(this,1)"   ng-click="cart.add(item)">+</button>
                                </div>
                                <div class="cell itemtotal ng-binding" ng-bind="'¥' + (item.price * item.quantity | number:2)">¥<?php echo e($food['total']); ?></div>
                            </div>
                    ...
                    <ul ng-if="cart.vm.extra || cart.vm.records" class="ng-scope"><!-- ngRepeat: item in cart.vm.extra -->
                        <li ng-repeat="item in cart.vm.extra" class="checkoutcart-tablerow extra ng-scope">
                            ...
                            <div class="cell itemtotal ng-binding" ng-class="{minus: item.price < 0}" ng-bind="'¥' + (item.price | number:2)">¥<?php echo e($shopcart['money']); ?></div>
                    ...
                    <div class="checkoutcart-total color-stress">¥
                        <span class="num ng-binding" ng-bind="cart.vm.total | number: 2"><?php echo e($shopcart['total'] + $shopcart['money']); ?></span>
                    </div>
                    <div class="checkoutcart-totalextra">共 
                        <span ng-bind="cart.pieces" class="ng-binding"><?php echo e($shopcart['num']); ?></span> 份商品<!-- ngIf: cart.vm.benefit -->
                    </div>
                </div>
            ...
            <div ng-if="!loading &amp;&amp; !nofood" class="checkout-content ng-scope">
                    ...
                    <ul ng-hide="!addressList.length" class="checkout-address-list" ng-class="{ showmore: showMoreAddress, showfirst: noInitAddress }"><!-- ngRepeat: item in addressList -->
                        ...
                        <li class="checkout-address ng-scope" ng-repeat="item in addressList" ng-click="selectAddress($event, item)" ng-class="{active: address.id === item.id}" ng-mouseenter="selectAddress($event, item)"><i class="checkout-address-icon icon-location-line"></i>
                            <div class="checkout-address-info">
                                <p ng-bind="item.name + [' ', ' 先生 ', ' 女士 '][item.sex] + item.phone" class="ng-binding"><?php echo e($address['name']." ".['', ' 先生 ', '女士 '][$address['sex']]." ".$address['phone']); ?></p>
                                <p class="color-weak ng-binding" ng-bind="item.address + item.address_detail"><?php echo e($address['address']); ?></p>
                            </div>
                ...
                <div class="checkout-select">
                    ...
                    <div class="checkout-info">
                        ...
                        <span>本订单由<a ng-bind="' [' + delivery + '] '" class="ng-binding"> [<?php echo e($ob->shopname); ?>] </a>提供配送</span>
                    </div>
    ...
    <script typt="text/javascript">
        //var  url = "/" + <?php echo e($ob->shopid); ?> + "/addorder";
        /*
        var  url = "/addorder";
        var  userid = <?php echo e($user->id); ?>; //用户id
        var  shopid = <?php echo e($ob->shopid); ?>; //商家id
        var  shop_name = "<?php echo e($ob->shopname); ?>"; //商家名
        var  shop_phone = "<?php echo e($ob->phone); ?>"; //商家电话
        var  goods_num = <?php echo e($shopcart['num']); ?>; //商品总数
        var  addressid = 1; //收货地址
        var  amount = <?php echo e($shopcart['total']); ?>; //总金额
        var  status = 1; //订单状态
        var  delivery_fee = <?php echo e($shopcart['money']); ?>; //配送费
        ...
        */
        ...
        function submitOrder(){
            ...
            crsf.name = "_token";
            crsf.value = "<?php echo e(csrf_token()); ?>";
            crsf.type = "hidden";
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.num<=0 && data.status==1){
                        ...
                        //$(e).parent().parent().parent().next().next().children("span:first").html(<?php echo e($shopcart['total'] + $shopcart['money']); ?>);
                        //alert(data.time);//
                        $(e).parent().parent().parent().parent().next().next().children("span:first").html(data.total + <?php echo e($shopcart['money']); ?>);
                    }
                },
                error:function(){
                    alert("失败了");
