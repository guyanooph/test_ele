					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					        <!--表单添加-->
					         <form action="<?php echo e(URL('admin/node')); ?>" id="form" method="post" class="form-horizontal" onsubmit="doCreate()">
                  ...
                  <table class="table table-bordered">
                    ...
                    <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($vo->method); ?></td>
                            <td><?php echo e($vo->url); ?></td>
                            <td><?php echo e($vo->state); ?></td>
                            <td><?php echo e($vo->created_at); ?></td>
                            <td><?php echo e($vo->updated_at); ?></td>
                            <td><button class="btn btn-xs btn-danger" onclick="doDel(<?php echo e($vo->id); ?>)">删除</button>                                      
                            <button type="button" onclick="doEdit('<?php echo e($vo->id); ?>')" class="btn  btn-xs btn-primary"> 修改 </button>
                            <!-- <button type="button" class="btn btn-xs btn-danger" onclick="window.location='<?php echo e(url('admin/node/edit')); ?>/<?php echo e($vo->id); ?>'">修改</button>-->
                             </td>
                        </tr>
    ...
    <script type="text/javascript">
            ...
            Modal.confirm({msg: "是否删除信息？"}).on(function(e){
                if(e){
                   var form = document.myform;
                    form.action = "<?php echo e(URL('/admin/node')); ?>/"+id;
                    form.submit(); 
                }
              });
        }
     ...
     function doEdit(id){
      ...
      $("#exampleModal").modal("show");
        $.ajax({
            url:"<?php echo e(url('admin/node/edit')); ?>/"+id,
            type:'get',
            dataType:"html",
            async:true,
      ...
      function saveNode(){
         $.ajax({
              url:"<?php echo e(URL("admin/node")); ?>/"+id,
              type:"post",
