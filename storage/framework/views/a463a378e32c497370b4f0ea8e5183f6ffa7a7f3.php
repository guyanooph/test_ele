<?php $__env->startSection('content'); ?>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <button onclick="window.location='<?php echo e(URL('admin/shop/check')); ?>/<?php echo e($list->id); ?>/<?php echo e(2); ?>'"class="btn btn-ms btn-primary">注册信息合法，通过审核</button>
            <button onclick="window.location='<?php echo e(URL('admin/shop/check')); ?>/<?php echo e($list->id); ?>/<?php echo e(3); ?>'" class="btn btn-ms btn-danger">注册信息不合法，不通过</button></li>
