...
@section('content')
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <button onclick="window.location='{{URL('admin/works/check')}}/{{$list->id}}/{{2}}'"class="btn btn-ms btn-primary">通过审核</button>
            <button onclick="window.location='{{URL('admin/works/check')}}/{{$list->id}}/{{3}}'" class="btn btn-ms btn-danger">不通过审核</button></li>
