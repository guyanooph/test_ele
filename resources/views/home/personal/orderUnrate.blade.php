...
<html ng-app="eleme" perf-error="desktop/profile/" class="ng-scope"><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>
  ...
  <body cute-title="" ng-class="{hidesidebar: layoutState &amp;&amp; layoutState.hideSidebar, smallbody: layoutState.smallBody, whitebody: layoutState.whiteBody}" style="position: relative;">
    ...
    <!-- ngView:  --><div ng-view="" role="main" class="ng-scope"><div class="unrated profile-container container" profile-container="" page-name="order-unrated" page-title="待评价订单" page-subtitle="带(<span class='stress'>*</span>)标志为必填项"><div class="clearfix"><div class="location" ng-style="{visibility: geohash ? '' : 'hidden'}" role="navigation" location=""><span>当前位置:</span> <span class="location-current"><a class="inherit ng-binding" ng-href="/place/wx4eqy3w3mce5" ubt-click="401" ng-bind="place.name || place.address" href="/place/wx4eqy3w3mce5">海淀区中关村E世界(欧美汇购物中心北170米)</a></span> <span class="location-change location-hashistory" ng-class="{ 'location-hashistory': user.username &amp;&amp; userPlaces &amp;&amp; userPlaces.length > 0 }"><a ng-href="/home" ubt-click="400" hardjump="" href="/home">[切换地址]</a><ul class="dropbox location-dropbox" ubt-visit="398"><li class="arrow"></li><!-- ngRepeat: userPlace in userPlaces | filter:filterPlace | limitTo: 4 --><li ng-repeat="userPlace in userPlaces | filter:filterPlace | limitTo: 4" class="ng-scope"><a class="inherit ng-binding" ng-href="/place/wx4eqy3qnsyr?latitude=39.981678&amp;longitude=116.31426" ng-bind="userPlace.name" ubt-click="399" href="/place/wx4eqy3qnsyr?latitude=39.981678&amp;longitude=116.31426">海淀区中关村E世界(欧美汇购物中心北170米)</a></li><!-- end ngRepeat: userPlace in userPlaces | filter:filterPlace | limitTo: 4 --><li ng-repeat="userPlace in userPlaces | filter:filterPlace | limitTo: 4" class="ng-scope"><a class="inherit ng-binding" ng-href="/place/wx4spk2n53e8?latitude=40.102509&amp;longitude=116.334373" ng-bind="userPlace.name" ubt-click="399" href="/place/wx4spk2n53e8?latitude=40.102509&amp;longitude=116.334373">昌平区北京市育荣教育园区(北京华文学院西北)</a></li><!-- end ngRepeat: userPlace in userPlaces | filter:filterPlace | limitTo: 4 --><li ng-repeat="userPlace in userPlaces | filter:filterPlace | limitTo: 4" class="ng-scope"><a class="inherit ng-binding" ng-href="/place/wx4fepv6duy?latitude=39.85748&amp;longitude=116.50636" ng-bind="userPlace.name" ubt-click="399" href="/place/wx4fepv6duy?latitude=39.85748&amp;longitude=116.50636">朝阳区垡头翠成馨园</a></li><!-- end ngRepeat: userPlace in userPlaces | filter:filterPlace | limitTo: 4 --><li ng-repeat="userPlace in userPlaces | filter:filterPlace | limitTo: 4" class="ng-scope"><a class="inherit ng-binding" ng-href="/place/wx4g54hye6mn?latitude=39.914459&amp;longitude=116.505693" ng-bind="userPlace.name" ubt-click="399" href="/place/wx4g54hye6mn?latitude=39.914459&amp;longitude=116.505693">朝阳区十里堡首创·爱这城北(朝阳路南)</a></li><!-- end ngRepeat: userPlace in userPlaces | filter:filterPlace | limitTo: 4 --><li class="changelocation"><a ng-href="/home" hardjump="" href="/home">修改收货地址<span class="icon-location"></span></a></li></ul></span> <span ng-transclude=""><i class="icon-arrow-right ng-scope"></i><span class="ng-binding ng-scope">待评价订单</span></span></div><div search-input=""></div></div><ul class="profile-sidebar" role="navigation" profile-sidebar=""><li class="profile-sidebar-section"><h2 class="profile-sidebar-sectiontitle" ng-class="{ active: pageName === 'profile' }"><i class="icon-line-home"></i><a href="/personal">个人中心</a></h2></li><li class="profile-sidebar-section"><h2 class="profile-sidebar-sectiontitle"><i class="icon-line-order"></i>我的订单</h2><ul><li ng-class="{ active: pageName === 'order' }"><a href="/personal/order">近三个月订单</a></li><li ng-class="{ active: pageName === 'order-unrated' }" class="active"><a href="/personal/order/unrated">待评价订单<!-- ngIf: unratedNumber --></a></li><li ng-class="{ active: pageName === 'order-refunding' }"><a href="/personal/order/refund">退单记录</a></li></ul></li><li class="profile-sidebar-section"><h2 class="profile-sidebar-sectiontitle"><i class="icon-yen"></i>我的资产</h2><ul><li ng-class="{ active: pageName === 'hongbao' }"><a href="/personal/red_packet">我的红包</a></li><li ng-class="{ active: pageName === 'balance' }"><a href="/personal/balance">账户余额</a></li><li ng-class="{ active: pageName === 'points' }"><a href="/personal/points">我的积分</a></li></ul></li><li class="profile-sidebar-section"><h2 class="profile-sidebar-sectiontitle"><i class="icon-line-profile"></i>我的资料</h2><ul><li ng-class="{ active: pageName === 'info' }"><a href="/personal/info">个人资料</a></li><li ng-class="{ active: pageName === 'address' }"><a href="/personal/address">地址管理</a></li><li ng-class="{ active: pageName === 'security-center' }"><a href="/personal/security">安全中心</a></li><li ng-class="{ active: pageName === 'changepassword' }"><a href="/personal/security/changepassword">修改密码</a></li></ul></li><li class="profile-sidebar-section"><h2 class="profile-sidebar-sectiontitle" ng-class="{ active: pageName === 'favor' }"><a href="/personal/collect"><i class="icon-order-favor"></i>我的收藏</a></h2></li></ul>
	
	
	
	
	
	<div class="profile-panel" role="main"><!-- ngIf: pageTitleVisible --><h3 ng-if="pageTitleVisible" class="profile-paneltitle ng-scope"><span ng-bind="pageTitle" class="ng-binding">待评价订单</span> <span class="subtitle ng-binding" ng-bind-html="pageSubtitle | toTrusted">带(<span class="stress">*</span>)标志为必填项</span></h3><!-- end ngIf: pageTitleVisible --><div class="profile-panelcontent" ng-transclude=""><!-- ngIf: fetched && !unrated --><div class="loading ng-binding ng-isolate-scope ng-hide" loading="" content="正在载入未评价订单" ng-hide="fetched"><!-- ngIf: type==='profile' --><img ng-if="type==='profile'" src="//faas.elemecdn.com/desktop/media/img/profile-loading.4984fa.gif" alt="正在加载" class="ng-scope"><!-- end ngIf: type==='profile' --> <!-- ngIf: type==='normal' -->正在载入未评价订单</div><!-- ngIf: unrated --><div ng-if="unrated" class="unrated-orderinfo ng-scope"><div class="unrated-orderinfo-item"><a ng-href="/shop/1987286" href="/shop/1987286"><img ng-src="//fuss10.elemecdn.com/c/c4/7d19d4ce51daffcb10d96b559863djpeg.jpeg?imageMogr2/thumbnail/48x48/format/webp/quality/85" alt="韩式炸鸡料理店" src="//fuss10.elemecdn.com/c/c4/7d19d4ce51daffcb10d96b559863djpeg.jpeg?imageMogr2/thumbnail/48x48/format/webp/quality/85"></a><div class="rstinfo"><h3><a class="color-normal ng-binding" ng-href="/shop/1987286" ng-bind="unrated.rstName" href="/shop/1987286">韩式炸鸡料理店</a></h3><p><span ng-bind="unrated.foodConcat" class="ng-binding">炸鸡三拼大份-原味.蒜香.火辣酱1份 / 香芋地瓜丸-一份12个1份等</span>共<span class="stress ng-binding" ng-bind="unrated.foodQuantity">4</span>个菜品</p></div></div><span class="unrated-orderinfo-item ng-binding" ng-bind="'下单时间：' + (unrated.created_at | date:'yyyy-MM-dd HH:mm:ss')">下单时间：2017-07-13 16:52:56</span> <a class="unrated-orderinfo-item favor" href="javascript:" ng-click="favorRst()" ng-class="isFavor &amp;&amp; 'active'"><i class="icon-line-star"></i>收藏商家</a></div><!-- end ngIf: unrated --><!-- ngIf: unrated --><div ng-if="unrated" class="unrated-rate ng-scope">
	...
	<div class="unrated-ratelist">
		...
		<div class="unrated-ratelist-content rate ng-isolate-scope" rate="" config="rateServiceConfig" value="rate.service" isreadonly="stableRate.service.value">
			<p class="rate-star star level0" ng-class="{readonly: isreadonly, star: starStyle}"><!-- ngIf: label --> 
				<span ng-click="doRate($event)" ng-mouseover="doRate($event)" ng-mouseleave="doRate($event)" data-level="0">
			...
			<div id="shop_yijian" ng-if="config.mutiContent" class="rate-content ng-scope ng-hide" ng-show="config.mutiContent &amp;&amp; value.value > 0" ng-hide="copyVal.value || copyVal.text === ''">
				<textarea ng-attr-placeholder="config.placeholder[rateLevel - 1]" ng-model="value.text" class="ng-pristine ng-valid" placeholder="请说出你的意见，我们又不改。。。"></textarea>
	...
	<span class="timeslider-time ng-binding" ng-bind="time ? time + '分钟' : '请评价送餐速度'" ng-class="{notime: !time}">0分钟</span></div></div>
	
	
	
	<div class="unrated-ratelist food"><span class="unrated-ratelist-label">评价菜品</span>
	
	<div class="unrated-ratelist-content"><!-- ngRepeat: food in rate.orderItems --><div class="rate ng-isolate-scope" ng-repeat="food in rate.orderItems" rate="" label="food.name" config="rateFoodConfig" value="rate.orderItems[$index].rate" isreadonly="stableRate.orderItems[$index].rate.value"><p class="rate-star level4" ng-class="{readonly: isreadonly, star: starStyle}"><!-- ngIf: label --><span class="rate-name ng-binding ng-scope" ng-if="label" ng-bind="label">炸鸡三拼大份-原味.蒜香.火辣酱</span><!-- end ngIf: label --> 
	...
	</span> <!-- ngIf: config.tipText --><span ng-if="config.tipText" class="active rate-star-text ng-binding ng-scope" ng-bind="config.tipText[rateLevel]">满意</span><!-- end ngIf: config.tipText --></p><!-- ngIf: config.mutiContent --><!-- ngIf: !config.mutiContent --><div ng-if="!config.mutiContent" class="rate-content simple ng-scope ng-hide" ng-show="!config.mutiContent &amp;&amp; value.value > 0" ng-hide="copyVal.value || value.value === 0"><textarea ng-attr-placeholder="config.placeholder[rateLevel - 1]" ng-model="value.text" class="ng-pristine ng-valid" placeholder="把好吃的地方说出来，帮助小伙伴选择"></textarea></div><!-- end ngIf: !config.mutiContent --><!-- ngIf: copyVal.text --></div><!-- end ngRepeat: food in rate.orderItems -->
	
	<!-- end ngRepeat: food in rate.orderItems --><!-- end ngRepeat: food in rate.orderItems --><!-- end ngRepeat: food in rate.orderItems --></div></div><div class="unrated-ratelist offset"><button onclick="doSubmit()" class="btn-primary btn-lg" ng-click="rateSubmit()">提交评价</button> <!-- ngIf: !canotRateNext --><!-- ngIf: !unrated.rate_info.rated_point && unrated.rate_info.total_rating_point --><p class="unrated-intro ng-scope" ng-if="!unrated.rate_info.rated_point &amp;&amp; unrated.rate_info.total_rating_point">评价后可获得<span class="unrated-tip ng-binding" ng-bind="unrated.rate_info.total_rating_point">1681</span>积分哦</p><!-- end ngIf: !unrated.rate_info.rated_point && unrated.rate_info.total_rating_point --></div></div><!-- end ngIf: unrated --></div></div></div></div>
