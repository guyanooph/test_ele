...
<html>
    <head>
        ...
        <title>饿了么收银台</title>
        <link href="/statics/v1/dist/app.96caca.css" rel="stylesheet">
                ...
                <section class="container order" data-reactid=".0.0">
                    ...
                    <div class="order-detail clearfix" data-reactid=".0.0.1">
                        <div class="pull-left" data-reactid=".0.0.1.0">
                            <p class="text-muted" data-reactid=".0.0.1.0.0">川湘菜馆外卖订单</p>
                            <p class="" data-reactid=".0.0.1.0.1">
                                <span class="text-muted text-ellipsis order-desc" data-reactid=".0.0.1.0.1.0">胡必腾 先生 137****6524 
育荣教育园区[公交站] [公交站]兄弟连LAMP
-
麻辣香锅一人超值套餐  x4
                                </span>
                                <a class="text-primary show-detail text-link" data-reactid=".0.0.1.0.1.1">
                                    <span data-reactid=".0.0.1.0.1.1.0">查看详情</span>
                                    <span class="triangle triangle-down" data-reactid=".0.0.1.0.1.1.1"></span>
                                </a>
                            </p>
                            <div class="hidden order-detail text-muted" data-reactid=".0.0.1.0.2">
                                <p data-reactid=".0.0.1.0.2.0">胡必腾 先生 137****6524 
育荣教育园区[公交站] [公交站]兄弟连LAMP
-
麻辣香锅一人超值套餐  x4
                                </p>
                                <a class="text-link" data-reactid=".0.0.1.0.2.1">
                                    <span data-reactid=".0.0.1.0.2.1.0">收起详情</span>
                                    <span class="triangle triangle-up" data-reactid=".0.0.1.0.2.1.1"></span>
                                </a>
                            </div>
                        </div>
                        <p class="pull-right" data-reactid=".0.0.1.1">
                            <span data-reactid=".0.0.1.1.0">
                                ...
                                <strong class="text-lg text-highlight" data-reactid=".0.0.1.1.0.1">
                                    <span data-reactid=".0.0.1.1.0.1.0">¥</span>
                                    <span data-reactid=".0.0.1.1.0.1.1">123.20</span>
                                </strong>
                            </span>
                        </p>
                    </div>
                ...
                <section class="container paymethods" data-reactid=".0.1">
                    <header data-reactid=".0.1.0">
                        ...
                        <p class="text-muted" data-reactid=".0.1.0.1">
                            ...
                            <span class="text-highlight" data-reactid=".0.1.0.1.1">8分50秒</span>
                    ...
                    <section class="third-payment" data-reactid=".0.1.2">
                        <div data-reactid=".0.1.2.0">
                            <p class="title text-muted" data-reactid=".0.1.2.0.0">
                                ...
                                <span class="text-highlight text-money" data-reactid=".0.1.2.0.0.1"> ￥123.20</span>
                            </p>
                            <ul class="third-payment-list clearfix" data-reactid=".0.1.2.0.1">
                                ...
                                <li class="weixin active" data-reactid=".0.1.2.0.1.$1">
                    ...
                    <footer class="paypassword" data-reactid=".0.1.3">
                        <form class="hide" name="password" data-reactid=".0.1.3.1">
                            ...
                            <section class="form-group" data-reactid=".0.1.3.1.1">
                                <input placeholder="请输入6位支付密码" class="" value="" data-reactid=".0.1.3.1.1.0" type="password">
                        ...
                        <button type="button" class="btn btn-success btn-lg" data-reactid=".0.1.3.4">确认支付</button>
                    </footer>


                </section>
                <section class="messagebox-backdrop" style="display:none;" data-reactid=".0.2">
                    <div class="messagebox " data-reactid=".0.2.0">
                    </div>
                </section>
            </main>
        </main>
