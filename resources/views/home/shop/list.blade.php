...
<head>
	...
	<script src="jjjjs/perf.js" type="text/javascript" crossorigin="anonymous"></script>
	<script src="jjjjs/vendor.3b50a2.js" type="text/javascript" crossorigin="anonymous"></script>
	<script src="jjjjjs/main.f4d5bb.js" type="text/javascript" crossorigin="anonymous"></script>
	<base href="/">
	...
	<div ng-show="!recentBoughtOnly" class="container ng-scope">
		<div class="excavator container"><!-- ngIf: rstCategories.length -->
			<div class="excavator-filter ng-scope" ng-if="rstCategories.length"><span class="excavator-filter-name">商家分类:</span>
				...
				<!-- end ngRepeat: category in rstCategories --><a class="excavator-filter-item ng-binding ng-scope"
				                                                   ...
				                                                   ng-class="{'focus': clickedCategory === category.id &amp;&amp; (!clickedCategory || clickedCategory < 0) , 'active': activeCategory === category.id, 'premium': category.id === -10001 &amp;&amp; !pumStream}"
				                                                   ng-bind="category.name"
				                                                   ng-click="changeCategory(category)" ubt-click="380">美食</a>
				<!-- end ngRepeat: category in rstCategories --><a class="excavator-filter-item ng-binding ng-scope"
				                                                   href="javascript:"
				                                                   ng-repeat="category in rstCategories"
				                                                   ng-class="{'focus': clickedCategory === category.id &amp;&amp; (!clickedCategory || clickedCategory < 0) , 'active': activeCategory === category.id, 'premium': category.id === -10001 &amp;&amp; !pumStream}"
				...
				<!-- end ngRepeat: category in rstCategories --><a class="excavator-filter-item ng-binding ng-scope"
				                                                   ...
				                                                   ng-class="{'focus': clickedCategory === category.id &amp;&amp; (!clickedCategory || clickedCategory < 0) , 'active': activeCategory === category.id, 'premium': category.id === -10001 &amp;&amp; !pumStream}"
				                                                   ng-bind="category.name"
				                                                   ng-click="changeCategory(category)" ubt-click="380">下午茶</a>
				<!-- end ngRepeat: category in rstCategories --><a class="excavator-filter-item ng-binding ng-scope"
				                                                   href="javascript:"
				                                                   ng-repeat="category in rstCategories"
				                                                   ng-class="{'focus': clickedCategory === category.id &amp;&amp; (!clickedCategory || clickedCategory < 0) , 'active': activeCategory === category.id, 'premium': category.id === -10001 &amp;&amp; !pumStream}"
			...
			</div><!-- end ngIf: rstCategories.length --></div>
		<div class="place-rstbox clearfix">
			<div class="clearfix"
			     ...
			     style="height: 840px;">
				 @foreach($list as $v)
				 <a href="/shoplist/1" data-rst-id="2" data-bidding="" target="_blank"
			                               class="rstblock">
					...
					<div class="rstblock-logo"><img src="//fuss10.elemecdn.com/8/38/68c554160c254ba06eef15bb963ebpng.png?imageMogr2/thumbnail/70x70/format/webp/quality/85"
								width="70" height="70" alt="{{ $v->title }}" class="rstblock-logo-icon"><span>{{ $v->service_time }}分钟</span>
					</div>
					<div class="rstblock-content">
						<div class="rstblock-title">{{ $v->shopname }}</div>
						<div class="starrating icon-star"><span class="icon-star" style="width:100%;"></span></div>
						<span class="rstblock-monthsales">月售</span>
						<div class="rstblock-cost">配送费:￥{{ $v->month_num }}</div>
