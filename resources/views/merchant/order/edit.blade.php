						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<label class="radio-inline">
									<input type="radio" name="status" id="inlineRadio1" {{ $order->status }} value="1"> 未配送
								</label>
								<label class="radio-inline">
									<input type="radio" name="status" id="inlineRadio2" {{ $order->status }} value="2">  已发货
								</label>
								<label class="radio-inline">
									<input type="radio" name="status" id="inlineRadio2" {{ $order->status }} value="3"> 确认收货
								</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="col-sm-4">
								<label class="radio-inline">
								   <input type="radio"  name="pay" {{ ($order->pay == 1)?"checked":"" }} value="1">货到付款  &nbsp; &nbsp;
								</label>
								<label class="radio-inline">
								   <input type="radio"  name="pay" {{ ($order->pay == 2)?"checked":"" }} value="2">在线支付
								</label>
							  </div>
							</div>
							<div class="form-group">
							  ...
							  <div class="col-sm-4">
								<label class="radio-inline">
								   <input type="radio"  name="distribution" {{ ($order->distribution == 1)?"checked":"" }} value="1">自营快送  &nbsp; &nbsp;
								</label>
								<label class="radio-inline">
								   <input type="radio"  name="distribution" {{ ($order->distribution == 2)?"checked":"" }} value="2">蜂鸟快送 
								</label>
							  </div>
							</div>
							<div class="form-group">
